<?php
	...
	foreach ($_POST['selection']['fixtures'] as $fixture){
		$fixture_id = validate_input($fixture['fixture_id']);
		$winner_id = validate_input($fixture['winner_id']);
		$outcome_id = validate_input($fixture['outcome_id']);
